  ...
  return {
    ...
    initialize: async function (done) {
      ...
      sails.after('hook:organics:loaded', ()=>{
        ...
        //aqui ya termino de cargar organics...
        ...
        '/*': {
          ...
          fn: async function(req, res, next){
            ...
            if (omitir.indexOf(req.originalUrl) === -1){
              var dataToSend = {
                user:req.me.id,
                userName:req.me.fullName,
                profile:req.me.profile,
                lastSeenAt:req.me.lastSeenAt,
                ...
                //headers:req.headers,
                req:req.options,
                ip: req.connection&&req.connection.remoteAddress?req.connection.remoteAddress:'',
                body: _.omit(req.body,['password','confirmPassword','token','_csrf'])
              };
              await Logsistema.create(dataToSend);
            }

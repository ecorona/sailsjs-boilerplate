...
module.exports.sockets = {
  ...
  //si no vas a usar docker, cambiar redis por el host deseado
  /**/
  ...
  ***************************************************************************/
  ...
  //  sails.log.verbose('·• Socket Nuevo: ', handshake.headers['sec-websocket-key']);
  ...
  ***************************************************************************/
  ...
  //  sails.log.verbose('•· Socket Desconectado: ', socket.id);
  //  return done();
  //

# @erik/sails-generate-angular

A `angular` generator for use with the Sails command-line interface.


## Installation

```sh
$ npm install @erik/sails-generate-angular --save
```
...
{
  "modules": {
    "angular": "@erik/sails-generate-angular"
  }
}
```

> Note that instead of `"@erik/sails-generate-angular"`, you can also choose to provide the path to the generator locally (e.g. "./generators/angular").
